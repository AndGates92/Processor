...
ddr2_ctrl_init_top: ${DDR2_CTRL_TB_PKG_WORK_DIR}/ddr2_pkg_tb.o ${DDR2_CTRL_TB_PKG_WORK_DIR}/ddr2_log_pkg.o ${COMMON_RTL_PKG_WORK_DIR}/functions_pkg.o ${COMMON_TB_PKG_WORK_DIR}/functions_pkg_tb.o ${COMMON_TB_PKG_WORK_DIR}/shared_pkg_tb.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_define_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_arbiter_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_arbiter_ctrl_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_arbiter_top_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_odt_ctrl_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_ref_ctrl_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_cmd_ctrl_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_bank_ctrl_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_col_ctrl_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_mrs_ctrl_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_ctrl_top_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_init_top_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_regs_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_top_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_init_top_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_ctrl_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_mrs_pkg.o ${DDR2_CTRL_RTL_PKG_WORK_DIR}/ddr2_gen_ac_timing_pkg.o
	@echo "Analysing ${DDR2_CTRL_RTL_DIR}/ddr2_ctrl_init.vhd"
	${GHDL} -a ${DDR2_CTRL_RTL_GHDL_ARGS} ${DDR2_CTRL_RTL_DIR}/ddr2_ctrl_init.vhd
	@echo "Analysing ${DDR2_CTRL_RTL_DIR}/ddr2_ctrl_arbiter.vhd"
	${GHDL} -a ${DDR2_CTRL_RTL_GHDL_ARGS} ${DDR2_CTRL_RTL_DIR}/ddr2_ctrl_arbiter.vhd
